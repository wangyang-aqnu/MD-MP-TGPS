...
def RC_item_to_tag(R_item_to_tag,SD_item_to_tag,O1):
...
def RC_user_to_item(R_user_to_item,SD_user_to_item,ST2_R_user):
...
def iteration(n,R_item_to_tag,SD_item_to_tag,R_tag_to_user,SD_tag_to_user,R_user_to_item,SD_user_to_item,O1):
    iter_n=0
    ST1_R_tag=RC_item_to_tag(R_item_to_tag,SD_item_to_tag,O1)
    ST2_R_user=RC_tag_to_user(R_tag_to_user,SD_tag_to_user,ST1_R_tag)
    ST3_R_item=RC_user_to_item(R_user_to_item,SD_user_to_item,ST2_R_user)
    while (iter_n <n):
...
####################################
    ...
    ST3_R_item=iteration(0,R_item_to_tag,SD_item_to_tag,R_tag_to_user,SD_tag_to_user,R_user_to_item,SD_user_to_item,O1)
