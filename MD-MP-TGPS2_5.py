...
def Fus_item(ST2_R_item,ST2_R_item_tag,itui_ST3_R_item,iuti_ST3_R_item,ST3_R_item_tag,tui_ST3_R_item,w1,w2,w3,w4,w5,w6):
  ...
  for item in ST2_R_item:
    Fus_ST3_R_item.setdefault(item)
    Fus_ST3_R_item[item]=w1*ST2_R_item[item]
    
  for item in ST2_R_item_tag:
    if item in Fus_ST3_R_item:
        if Fus_ST3_R_item[item]<w2*ST2_R_item_tag[item]:
            Fus_ST3_R_item[item]=w2*ST2_R_item_tag[item]
    else:
        Fus_ST3_R_item.setdefault(item)
        Fus_ST3_R_item[item]=w2*ST2_R_item_tag[item]
  ...
  for item in itui_ST3_R_item:
    if item in Fus_ST3_R_item:
        if Fus_ST3_R_item[item]<w3*itui_ST3_R_item[item]:
            Fus_ST3_R_item[item]=w3*itui_ST3_R_item[item]
    else:
        Fus_ST3_R_item.setdefault(item)
        Fus_ST3_R_item[item]=w3*itui_ST3_R_item[item]
  ...
  for item in iuti_ST3_R_item:
    if item in Fus_ST3_R_item:
        if Fus_ST3_R_item[item]<w4*iuti_ST3_R_item[item]:
            Fus_ST3_R_item[item]=w4*iuti_ST3_R_item[item]
    else:
        Fus_ST3_R_item.setdefault(item)
        Fus_ST3_R_item[item]=w4*iuti_ST3_R_item[item]
  ...
  for item in ST3_R_item_tag:
    if item in Fus_ST3_R_item:
        if Fus_ST3_R_item[item]<w5*ST3_R_item_tag[item]:
            Fus_ST3_R_item[item]=w5*ST3_R_item_tag[item]
    else:
        Fus_ST3_R_item.setdefault(item)
        Fus_ST3_R_item[item]=w5*ST3_R_item_tag[item]     
  ...
  for item in tui_ST3_R_item:
    if item in Fus_ST3_R_item:
        if Fus_ST3_R_item[item]<w6*tui_ST3_R_item[item]:
            Fus_ST3_R_item[item]=w6*tui_ST3_R_item[item]
    else:
        Fus_ST3_R_item.setdefault(item)
        Fus_ST3_R_item[item]=w6*tui_ST3_R_item[item]
...
f=open('MD-MP-TGPS2_5.txt','a')
f.write("u5:\n")
for i in range(10,110,10):
#for de in np.arange(0,1.01,0.01):
  avg_HR,avg_ILD,Ham_dist,avg_PO,Apris=pers_recom("train5.dat","test5.dat",i,15,1,1,1,1,1,1,1)
